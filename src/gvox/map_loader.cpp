      ...
      for (int y = 0; y < region->range.extent.y; ++y)
      {
        for (int x = 0; x < region->range.extent.x; ++x)
        {
          ...
          if (region_sample.is_present != 0)
          {
            ...
            {
#if MPM_ON == 1
              // daxa_f64 E = daxa_f32(1e-4f);
              daxa_f64 E = daxa_f32(1e-3f);
              daxa_f64 nu = daxa_f32(0.2f);
#endif // MPM_ON
...
#if MPM_ON == 1
                    ,
                .hardening = daxa_f32(10.0f),
                .E = (daxa_f32)(E),
                .nu = (daxa_f32)(nu),
                .mu_0 = (daxa_f32)(E / (2 * (1 + nu))),
                .lambda_0 = (daxa_f32)((E * nu) / ((1 + nu) * (1 - 2 * nu))),
                .volume = daxa_f32(VOXEL_EXTENT),
                .mass = daxa_f32(1.0f),
#endif // MPM_ON
              };
            ...
            if (user_state.params.max_primitive_count > user_state.scene_info.primitive_count + first_voxel_index)
            {
              ...
              if (light_found)
              {
                ...
                user_state.params.primitives[index] = PRIMITIVE
                {
                  mat_index, light_index
#if MPM_ON == 1
                      ,
                      daxa_f32vec3(0, 0, 0),
                      glm_mat3_to_daxa_f32mat3x3(glm::mat3(1.0f)),
                      glm_mat3_to_daxa_f32mat3x3(glm::mat3(0.0f)),
                      daxa_f32(1.0f)
#endif // MPM_ON
                };
              ...
              else
              {
                user_state.params.primitives[index] = PRIMITIVE
                {
                  mat_index, static_cast<uint32_t>(-1)
#if MPM_ON == 1
                                 ,
                      daxa_f32vec3(0, 0, 0),
                      glm_mat3_to_daxa_f32mat3x3(glm::mat3(1.0f)),
